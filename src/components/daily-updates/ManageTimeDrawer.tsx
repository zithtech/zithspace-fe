    ...
    <Drawer
      title={
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <div style={{ background: "#f0f9ff", padding: 8, borderRadius: 10, color: "#0ea5e9", display: "flex" }}>
            <Activity size={20} />
          </div>
        ...
        <Space size={16}>
          {selectedUser && (
            <div style={{
              ...
              <Text strong style={{ color: "#0369a1", fontSize: 13 }}>Total: {totalHours}h</Text>
            </div>
          )}
          <Space>
            ...
            <Button
              ...
              style={{ borderRadius: 10, background: "#0ea5e9" }}
            >
              Submit Update
            </Button>
          </Space>
      ...
      <div className="daily-update-drawer-container" style={{ height: "100%", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ padding: "24px", flex: 1, overflowY: "auto" }}>
          <Form form={form} layout="vertical">
            <Card
              size="small"
              style={{ marginBottom: 24, background: "#f8fafc", border: "1px solid #e2e8f0", borderRadius: 16, boxShadow: "inset 0 1px 2px 0 rgb(0 0 0 / 0.05)" }}
            >
              <Form.Item
                label={<Text strong style={{ color: "#334155" }}>Select Team Member</Text>}
                name="userId"
            ...
            {selectedUser ? (
              <>
                <div style={{ background: "#ffffff", padding: "16px", borderRadius: 16, border: "1px solid #f1f5f9", marginBottom: 24 }}>
                  <Row gutter={24} align="middle">
                    ...
                    <Col span={5}>
                      <Form.Item name="is_missed" label="Missed Update?" valuePropName="checked" style={{ marginBottom: 0 }}>
                        <Switch style={{ background: form.getFieldValue('is_missed') ? '#0ea5e9' : '#cbd5e1' }} />
                      </Form.Item>
                    </Col>
                    <Col span={5}>
                ...
                <Divider style={{ margin: "12px 0 32px" }}>
                  <Text strong style={{ color: "#94a3b8", fontSize: 12, textTransform: "uppercase", letterSpacing: "0.05em" }}>Project Activities</Text>
                </Divider>
                  ...
                  <Card
                    ...
                    title={
                      <Space>
                        ...
                        <Text strong style={{ fontSize: 13, color: "#334155" }}>Project Update #{pIdx + 1}</Text>
                      </Space>
                    }
                    extra={
                ...
                <Button
                  ...
                  block
                  icon={<Plus size={16} />}
                  style={{ height: 48, borderRadius: 14, marginBottom: 32, borderStyle: "dashed", borderColor: "#bae6fd", color: "#0ea5e9", fontWeight: 600 }}
                >
              ...
              <div style={{ padding: "80px 0", textAlign: "center", background: "#f8fafc", borderRadius: 20, border: "2px dashed #e2e8f0" }}>
                <div style={{
                  width: 64,
                  height: 64,
                  background: "#f1f5f9",
                ...
                <Title level={5} style={{ color: "#475569", margin: "0 0 8px" }}>No Member Selected</Title>
