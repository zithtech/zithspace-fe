...
export default function PositionsPage() {
  ...
  const [subDepartmentFilter, setSubDepartmentFilter] = useState<string | null>(
    null,
  );
  ...
  const columns = [
    {
      ...
      dataIndex: "code",
      key: "code",
      sorter: (a: PositionViewData, b: PositionViewData) =>
    ...
    },
    {
      ...
      dataIndex: "gradeId",
      key: "gradeId",
      render: (gradeId: string, record: PositionViewData) =>
        record.gradeName || grades?.find((g) => g.key === gradeId)?.name || "-",
    },
    {
      title: "Department",
      dataIndex: "departmentId",
      key: "departmentId",
      render: (deptId: string, record: PositionViewData) =>
    ...
    },
    {
      ...
      key: "subDepartmentId",
      render: (subDeptId: string, record: PositionViewData) =>
        record.subDepartmentName ||
        subDepartments?.find((sd) => sd.id === subDeptId)?.name ||
        "-",
    },
    {
      title: "Status",
      ...
      <MainLayout>
        ...
        <div style={{marginTop:20}}>
          ...
          <div style={{ display: "flex", gap: 12, marginBottom: 16 }}>
            ...
            >
              {grades.map((g) => (
                <Select.Option key={g.key} value={g.key}>
                  {g.name}
                </Select.Option>
              ))}
            </Select>
            ...
            >
              {subDepartments
                .filter(
                  (sd) =>
                    !departmentFilter ||
                    sd.parentDepartmentId === departmentFilter,
                )
                .map((sd) => (
