...
interface ProjectFiltersProps {
  ...
  onFilterChange: (key: keyof ProjectFiltersState, value: any) => void;
  onReset?: () => void;
...
/**
 * The Filters popover for Projects Management — the same panel shape the
 * Ticket List and the other lists use. These three used to live in the left
...
const ProjectFilters: React.FC<ProjectFiltersProps> = ({
  ...
  return (
    <div className="tf-panel">
      <style dangerouslySetInnerHTML={{ __html: PROJECT_FILTERS_CSS }} />
      ...
      <div className="tf-body">
        ...
        <div className="tf-row">
          ...
          <TicketFilterPill
            ...
            onChange={(val) => onFilterChange("projectManagerId", val || null)}
            placeholder="Anyone"
            itemNoun="managers"
            width={240}
            showAvatar
      ...
      <div className="tf-foot">
        <Text className="tf-foot-hint">
          {activeCount === 0
            ? "No filters applied — showing every project."
