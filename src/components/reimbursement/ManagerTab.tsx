...
//       dataIndex: "category",
//       width: 110,
//       render: (text) => <span className="capitalize text-xs">{text}</span>,
//     },
//     {
//       title: "Amount",
//       width: 100,
//       render: (_, r) => <span className="font-semibold text-xs">₹{r.amount.toLocaleString("en-IN")}</span>,
//     },
//     {
//       title: "Submitted",
//       dataIndex: "submitted",
...
//               className="text-green-600 hover:text-green-700 hover:bg-green-50 w-6 h-6"
//               onClick={() => {
//                 setCurrentRecord(record);
//                 setActionType("approve");
//               }}
...
//               className="text-red-600 hover:text-red-700 hover:bg-red-50 w-6 h-6"
//               onClick={() => {
//                 setCurrentRecord(record);
//                 setActionType("reject");
//               }}
...
//             <Button
//               type="text"
//               icon={<QuestionCircleOutlined style={{ fontSize: 12 }} />}
//               className="text-orange-600 hover:text-orange-700 hover:bg-orange-50 w-6 h-6"
//               onClick={() => {
//                 setCurrentRecord(record);
//                 setActionType("clarify");
//               }}
...
//   return (
//     <Card className="rounded-lg shadow-sm bg-white h-[500px] flex flex-col border border-gray-100">
...
//               View and take action on employee claims.
//             </p>

//             {/* ✅ CHIPS – COMPACT */}
//             <div className="flex flex-wrap gap-1">
//               <div className="px-1.5 py-0.5 rounded-full bg-blue-50 text-blue-700 text-[10px] font-medium border border-blue-100">
//                 Pending: {pendingRequests.length}
//               </div>

//               <div className="px-1.5 py-0.5 rounded-full bg-orange-50 text-orange-700 text-[10px] font-medium border border-orange-100">
//                 Review: {clarifyRequests.length}
//               </div>

//               <div className="px-1.5 py-0.5 rounded-full bg-green-50 text-green-700 text-[10px] font-medium border border-green-100">
...
//               value={searchText}
//               onChange={(e) => setSearchText(e.target.value)}
//               className="w-36 px-2 py-1 rounded border border-gray-200 text-[10px] focus:outline-none focus:border-blue-500 bg-gray-50/50"
//             />
...
//               {showFilter && (
//                 <div
//                   className="absolute right-0 top-full mt-1 w-56 bg-white border border-gray-200 rounded shadow-lg p-2 z-50"
//                 >
//                   {/* HEADER */}
...
//                       value={dateFilter}
//                       onChange={(e) => setDateFilter(e.target.value)}
//                       className="w-full px-1.5 py-1 border border-gray-200 rounded text-[10px] focus:border-blue-500 focus:outline-none"
//                     />
//                   </div>
...
//                       value={statusFilter}
//                       onChange={(e) => setStatusFilter(e.target.value)}
//                       className="w-full px-1.5 py-1 border border-gray-200 rounded text-[10px] focus:outline-none focus:border-blue-500"
//                     >
//                       <option value="PENDING_APPROVAL">Pending</option>
//                       <option value="CLARIFY">Clarification</option>
//                       <option value="APPROVED">Approved</option>
...
//                       type="primary"
//                       onClick={() => setShowFilter(false)}
//                       className="text-[9px] px-3 h-5 bg-blue-600 hover:bg-blue-700"
//                     >
//                       Apply
//                     </Button>
//                   </div>
...
//                           : "orange"
//                     }
//                     className="rounded-full px-2 py-0.5 text-[9px] font-medium border-0"
//                   >
//                     {selectedRow?.status || "PENDING"}
//                   </Tag>
//                   <CloseOutlined
//                     className="cursor-pointer text-gray-500 hover:text-gray-900 text-xs transition-colors"
//                     onClick={() => setOpen(false)}
//                   />
//                 </div>
//               </div>
...
//                   type="primary"
//                   size="small"
//                   className="bg-green-500 hover:bg-green-600 border-none px-3 text-xs"
//                   onClick={async () => {
//                     if (!selectedRow) return;
//                     await performManagerAction({ id: selectedRow.id, data: { action: "APPROVE" } });
//                     setOpen(false);
...
//         >
//           {selectedRow && (
//             <div className="h-full flex flex-col text-xs text-gray-700">
//               {/* ================= SUMMARY ================= */}
//               <div className="flex-shrink-0">
//                 <div className="mb-1.5 font-semibold text-sm text-gray-900">
//                   Summary
//                 </div>

//                 <div className="rounded-lg bg-gradient-to-br from-white to-slate-50 p-3 border border-slate-200 space-y-1.5 shadow-sm">
//                   {[
//                     ["Category", selectedRow.category],
...
//                     <div
//                       key={i}
//                       className="flex justify-between text-[10px] py-0.5 px-1 hover:bg-slate-100 rounded transition-colors"
//                     >
...
//                   {/* MANAGER STATUS */}
//                   <div className="flex justify-between text-[10px] py-0.5 px-1">
...
//                       return (
//                         <div key={i} className="group flex items-start gap-2 p-2 bg-gradient-to-r from-slate-50 to-white border border-slate-200 rounded shadow-sm">
//                           <div className="flex-1 min-w-0">
//                             <div className="font-medium text-xs group-hover:text-blue-700 transition-colors truncate">{item.title}</div>
//                             <div className="text-[9px] text-gray-500 mt-0.5">{item.date} • ₹{item.amount}</div>
//                           </div>
...
//                                 <div
//                                   key={idx}
//                                   className="flex items-center justify-between bg-white p-1 rounded text-[9px] shadow-sm border border-slate-100 h-6"
//                                 >
//                                   <span className="truncate font-medium text-gray-800 max-w-[60px]">
//                                     {getFileName(file)}
//                                   </span>
...
//                                       type="text"
//                                       disabled={!!downloadingFile}
//                                       className="!p-0 w-4 h-4 text-gray-600 hover:text-blue-600"
//                                       onClick={(e) => {
//                                         e.stopPropagation();
//                                         handlePreview(file);
//                                       }}
...
//                                       loading={downloadingFile === file}
//                                       disabled={!!downloadingFile && downloadingFile !== file}
//                                       className="!p-0 w-4 h-4 text-gray-600 hover:text-green-600"
//                                       onClick={(e) => {
//                                         e.stopPropagation();
//                                         handleDownload(file);
//                                       }}
//                                     >
//                                       {downloadingFile !== file && <DownloadOutlined style={{ fontSize: 10 }} />}
//                                     </Button>
//                                   </div>
//                                 </div>
//                               ))}
...
//                                     size="small"
//                                     type="link"
//                                     className="p-0 text-[9px] text-blue-600 hover:text-blue-700 font-medium h-auto"
//                                   >
//                                     +{files.length - 2} more
//                                   </Button>
//                                 </div>
...
//                 {/* ACTIVITY LOG */}
//                 <div>
//                   <div className="mb-1.5 font-semibold text-sm text-gray-900">Activity</div>

//                   <Timeline>
//                     {selectedRow.activityLog.slice(-3).map((log, i) => (
//                       <Timeline.Item key={i}>
//                         <div className="text-[9px] font-semibold text-gray-700">{log.action}</div>
//                         {log.note && (
//                           <div className="text-[9px] text-gray-500 italic">"{log.note}"</div>
//                         )}
//                         <div className="text-[8px] text-gray-400 mt-0.5">{log.date}</div>
//                       </Timeline.Item>
//                     ))}
//                   </Timeline>
//                 </div>
...
//           {/* FOOTER */}
//           <div className="flex justify-end gap-1.5 px-4 py-2 bg-white border-t border-gray-200">
//             <Button
//               size="small"
//               onClick={() => {
//                 setActionType(null);
...
//               className={
//                 actionType === "approve"
//                   ? "bg-green-500 hover:bg-green-600 border-none px-4 text-xs"
//                   : actionType === "reject"
//                     ? "bg-red-500 hover:bg-red-600 border-none px-4 text-xs"
//                     : "bg-blue-500 hover:bg-blue-600 border-none px-4 text-xs"
//               }
//               onClick={async () => {
//                 if (!currentRecord) return;
