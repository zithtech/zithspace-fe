...
import { Drawer, Avatar, Tag, Space, Typography, Row, Col, Divider, Collapse } from 'antd';
import {
  ClockCircleOutlined,
  FileTextOutlined,
...
export default function UpdateDetailsDrawer({ update, open, onClose }: UpdateDetailsDrawerProps) {
