  ...
  return (
    <div className="mr-wrap">
      ...
      {loading ? (
        ...
        <div className="mr-center">
          <Empty
            ...
            description={<Text style={{ fontSize: 12.5, color: '#64748b' }}>You don’t have any reports yet.</Text>}
          />
        </div>
      ) : (
      ...
      <style jsx global>{`
        ...
        .mr-title { margin: 0; font-size: 19px; font-weight: 800; color: #0f172a; letter-spacing: -0.02em; }
        .mr-sub { margin: 4px 0 0; font-size: 13px; color: #64748b; max-width: 560px; line-height: 1.5; }
        ...
        .mr-card { border: 1px solid #e9eef5; border-radius: 16px; background: #fff; padding: 18px; display: flex; flex-direction: column; gap: 14px; transition: box-shadow .15s ease, border-color .15s ease; }
        .mr-card:hover { box-shadow: 0 8px 24px rgba(15,23,42,0.07); border-color: #dbe4f0; }
        .mr-card-top { display: flex; align-items: flex-start; justify-content: space-between; gap: 10px; }
        .mr-month { font-size: 16px; font-weight: 800; color: #0f172a; }
        .mr-gen { font-size: 11px; color: #94a3b8; margin-top: 2px; }
        ...
        .mr-score-max { font-size: 13px; font-weight: 700; color: #94a3b8; }
        .mr-score-label { font-size: 11.5px; color: #64748b; margin-left: auto; align-self: center; }
        .mr-modules { display: flex; gap: 6px; }
        .mr-mod { flex: 1; text-align: center; background: #f8fafc; border: 1px solid #f1f5f9; border-radius: 8px; padding: 7px 2px; }
        .mr-mod-val { font-size: 15px; font-weight: 800; }
        .mr-mod-label { font-size: 9px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.03em; color: #94a3b8; margin-top: 1px; }
