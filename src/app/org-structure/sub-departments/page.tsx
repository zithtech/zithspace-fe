...
export default function SubDepartmentsPage() {
  ...
  const { subDepartments, loading: subDepartmentsLoading, fetchSubDepartments, createSubDepartment, updateSubDepartment, deleteSubDepartment } = useSubDepartments();
                       ...
                       <div style={{ display: "flex", gap: 12 }}>
                         ...
                         >
                          ...
                          <Input.Search
                           ...
                           style={{ width: 300 }}
                         />
                         <Button type="primary" icon={<PlusOutlined />} onClick={handleAdd}>Add Sub-Department</Button>
                       </div>
                     </div>

                     <Space style={{ marginBottom: 16 }}>
                       <Tag style={{ borderRadius: 12 }}>Total Sub-Departments: {totalSubDepartments}</Tag>
                       <Tag style={{ borderRadius: 12 }} color="green">Active: {activeSubDepartments}</Tag>
                       <Tag style={{ borderRadius: 12 }} color="red">Inactive: {inactiveSubDepartments}</Tag>
                     </Space>
                     ...
                     <Form form={form} layout="vertical">
                       <Row gutter={16}>
                         ...
                         <Col span={12}>
                           ...
                           >
                             <Input placeholder="e.g. Recruitment" onChange={handleNameChange} />
                           </Form.Item>
                         </Col>
                       </Row>
                       <Form.Item
                         ...
                         rules={[{ required: true, message: "Please select parent department" }]}
                       >
                         <Select placeholder="Select Parent Department" loading={departmentsLoading} showSearch optionFilterProp="children">
                           {departments.map((dept) => (
                             <Select.Option key={dept.id} value={dept.id}>
                               {dept.name}
                             </Select.Option>
