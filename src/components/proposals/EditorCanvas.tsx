    ...
    <div style={{ 
      ...
      <div 
        ...
        style={{ 
          ...
          borderRadius: '4px',
          padding: '60px 80px', // Proper document margins
          display: 'flex',
          flexDirection: 'column',
          position: 'relative',
      ...
      >
        {blocks.length === 0 ? (
          <div style={{ 
            ...
            <Title level={4} style={{ color: '#1e293b', marginBottom: '8px' }}>Start Building Your Proposal</Title>
            <Text style={{ color: '#64748b', maxWidth: '300px' }}>
