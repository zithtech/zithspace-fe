...
// //       const categoryData: any = {
// //         name: values.category,
// //         code: values.code, // Include the code field
// //         maxPerRequest: values.categoryMax,
// //         monthlyLimit: values.monthlyLimit,
// //         yearlyLimit: values.yearlyLimit,
// //         eligibleRoles: values.eligibleRoles || [],
...
// //     form.setFieldsValue({
// //       category: record.name,
// //       code: record.code, // Set the code field
// //       categoryMax: record.maxPerRequest,
// //       monthlyLimit: record.monthlyLimit,
// //       yearlyLimit: record.yearlyLimit,
// //       eligibleRoles: record.eligibleRoles,
...
// //   // Transform category name to uppercase and replace spaces with underscores for Code field
// //   const handleCategoryChange = (e: React.ChangeEvent<HTMLInputElement>) => {
// //     const value = e.target.value;
// //     // Keep the original value in category field (don't transform it)
// //     form.setFieldValue('category', value);
    
// //     // Transform for code field: replace spaces with underscores and convert to uppercase
// //     const transformedCode = value.replace(/\s+/g, '_').toUpperCase();
// //     form.setFieldValue('code', transformedCode);
// //   };
...
// //   },
// //   {
// //     title: "Max Requests/Month",
// //     dataIndex: "maxRequestsPerMonth",
...
// //       name: record.name,
// //       code: record.code,
// //       maxRequestsPerMonth: record.maxRequestsPerMonth,
...
// //             </h3>
// //             <p className="text-xs text-gray-500 mt-0.5">
// //               {editingItem ? "Update reimbursement setting" : "Add new reimbursement setting"}
// //             </p>
// //           </div>
...
// //               label={<span className="text-xs font-medium">Max Requests/Month</span>}
// //             >
// //               <InputNumber
// //                 className="w-full text-sm"
