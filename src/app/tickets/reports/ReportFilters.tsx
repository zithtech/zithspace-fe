...
interface ReportFiltersProps {
  ...
  onFilterChange: (key: keyof ReportFiltersState, value: any) => void;
  onReset?: () => void;
  statusOptions: FilterOption[];
  healthOptions: FilterOption[];
  completionOptions: FilterOption[];
}

/**
 * The Filters popover for Sprint Reports — the same panel shape the Ticket
 * List and the other lists use, so every list filters alike.
 */
const ReportFilters: React.FC<ReportFiltersProps> = ({
  ...
  return (
    <div className="tf-panel">
      <style dangerouslySetInnerHTML={{ __html: REPORT_FILTERS_CSS }} />
      ...
      <div className="tf-body">
        <div className="tf-row">
          <div className="tf-row-label">
            <FileDoneOutlined className="tf-row-icon" />
            <span>Report</span>
          </div>
          <TicketFilterPill
            label="Report"
        ...
        <div className="tf-row">
          <div className="tf-row-label">
            <HeartOutlined className="tf-row-icon" />
            <span>Health</span>
          </div>
          <TicketFilterPill
            label="Health"
            ...
            onChange={(val) => onFilterChange("health", val || null)}
            placeholder="Any"
            itemNoun="bands"
            width={220}
            multiple={false}
        ...
        <div className="tf-row">
          ...
          <TicketFilterPill
            ...
            onChange={(val) => onFilterChange("completion", val || null)}
            placeholder="Any"
            itemNoun="ranges"
            width={220}
            multiple={false}
      ...
      <div className="tf-foot">
        <Text className="tf-foot-hint">
          {activeCount === 0
            ? "No filters applied — showing every completed sprint."
