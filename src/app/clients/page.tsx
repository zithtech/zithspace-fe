                  ...
                  options={[
                    {
                      label: (
                        <Space size={6}>
                          <AppstoreOutlined />
                          <span style={{ fontWeight: 500 }}>Card View</span>
                        </Space>
                      ),
                      value: "card",
                    },
                    {
                      label: (
                        <Space size={6}>
                          <BarsOutlined />
                          <span style={{ fontWeight: 500 }}>List View</span>
                        </Space>
                      ),
                      value: "list",
                    },
            ...
            {loading
              ? [1, 2, 3, 4].map((i) => (
                  <Col xs={24} sm={12} lg={8} xl={6} key={i}>
                    <Card loading style={{ height: 320, borderRadius: 16 }} />
                  </Col>
                ))
              : clients.map((client) => (
                  <Col xs={24} sm={12} lg={8} xl={6} key={client.id}>
                    <Card
                      ...
                      style={{
                        ...
                        boxShadow: "0 4px 12px rgba(0,0,0,0.08)", // card shadow
                    ...
                    >
                      ...
                      >
                        <Avatar
                          size={48}
                          style={{
                            backgroundColor: "#1890ff", // fixed blue
                            fontWeight: "bold",
                            fontSize: 20,
                          }}
                        >
                      ...
                      >
                        <Space direction="vertical" size={6}>
                          <Space size={4}>
                            ...
                            <Text style={{ fontSize: 12 }}>{client.email}</Text>
                          </Space>
                          {client.phone && (
                            <Space size={4}>
