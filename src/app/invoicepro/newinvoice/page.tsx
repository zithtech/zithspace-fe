...
export default function InvoiceproNewinvoicePage() {
  ...
  //   form.setFieldsValue({
  //     ...invoice,
  //     customer_snapshot: invoice.customer_snapshot || invoice.customer, // 🔁 migrate old invoices
  ...
  useEffect(() => {
    if (editInvoiceNumber) return; // editing existing invoice → don't use draft
  ...
  //   const payload = {
  //     ...values,
  //     customer_snapshot: values.customer_snapshot, // ✅ snapshot only
  ...
  //       inv.invoice_number === editInvoiceNumber ? payload : inv
  //     );
  ...
  const selectedCustomer = customerSnapshot;
