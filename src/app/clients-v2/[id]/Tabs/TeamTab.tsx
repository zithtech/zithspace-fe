...
export default function TeamTab({ clientId, projects = [], onCountChange, onRefresh }: Props) {
  ...
  const load = async (page = currentPage, size = pageSize, search = searchQuery, project = projectFilter) => {
    setLoading(true);
    try {
      const res = await teamService.listForClient(clientId, {
        page,
        limit: size,
        search,
  ...
  const handleRefresh = async () => {
    try {
      setRefreshing(true);
      await Promise.all([
        load(currentPage, pageSize, searchQuery, projectFilter),
  ...
  useEffect(() => {
    const t = setTimeout(() => {
      setCurrentPage(1);
      load(1, pageSize, searchQuery, projectFilter);
    }, 300);
  ...
  return (
    <div style={{ color: c.text }} className="team-tab-container">
      {contextHolder}
      {modalContextHolder}
      ...
      {totalCount > 0 && (
        <div className="pm2-pagination team-pagination-footer">
      ...
      <style dangerouslySetInnerHTML={{
        ...
        [data-theme="dark"] .team-pagination-footer {
        ...
        .team-pagination-footer .ant-pagination-item,
        .team-pagination-footer .ant-pagination-prev .ant-pagination-item-link,
        .team-pagination-footer .ant-pagination-next .ant-pagination-item-link {
          border: 1px solid var(--border-slate-200) !important;
          border-radius: 6px !important;
          background: transparent !important;
          color: var(--text-slate-500) !important;
        }
        .team-pagination-footer .ant-pagination-item-active {
          background: #3b82f6 !important;
          border-color: #3b82f6 !important;
        }
        .team-pagination-footer .ant-pagination-item-active a {
          color: #fff !important;
        }
        .team-pagination-footer .ant-select-selector {
          border: 1px solid var(--border-slate-200) !important;
          border-radius: 6px !important;
          background: transparent !important;
        ...
        [data-theme="dark"] .team-pagination-footer .ant-pagination-item,
        [data-theme="dark"] .team-pagination-footer .ant-pagination-prev .ant-pagination-item-link,
        [data-theme="dark"] .team-pagination-footer .ant-pagination-next .ant-pagination-item-link {
          border-color: #374151 !important;
          background: #111827 !important;
          color: #9ca3af !important;
        }
        [data-theme="dark"] .team-pagination-footer .ant-pagination-item-active {
          background: #3b82f6 !important;
          border-color: #3b82f6 !important;
        }
        [data-theme="dark"] .team-pagination-footer .ant-pagination-item-active a {
          color: #fff !important;
        }
        [data-theme="dark"] .team-pagination-footer .ant-select-selector {
          border-color: #374151 !important;
          background: #111827 !important;
