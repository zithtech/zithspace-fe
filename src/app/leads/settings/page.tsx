                    ...
                    <div style={{ marginBottom: 32, display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
                        <div style={{ flex: 1 }}>
                            <Space size={12} align="center">
                                ...
                                <div style={{ flex: 1 }}>
                                    <Title level={2} style={{ margin: 0, fontWeight: 700, color: "var(--text-slate-900)" }}>Workflow Settings</Title>
                                    <Text style={{ color: "var(--text-slate-500)", fontSize: 15 }}>Configure status stages and available actions for lead management.</Text>
                                </div>
                            </Space>
                        </div>
