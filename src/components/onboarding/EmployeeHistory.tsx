...
// const BasicInformationStep = ({ index, form }: any) => {
//   return (
...
// const DocumentsStep = ({ index, form }: any) => {
//   const [activeKey, setActiveKey] = useState<string | string[]>(["0"]);
//   const getLetter = (idx: number) => String.fromCharCode(65 + idx);
...
//                   }}
//                 >
//                   <span style={{ fontWeight: 500 }}>Contact Persons</span>
//                   <Button
//                     type="dashed"
//                     icon={<PlusOutlined />}
//                     size="small"
...
// /* ================= COMPANY FORM WITH STEPS ================= */

// const CompanyFormWithSteps = ({ index, form }: any) => {
//   const [currentStep, setCurrentStep] = useState(0);

//   const steps = [
//     {
//       title: "Basic Information",
//       description: "Company & Tenure Details",
//     },
//     {
//       title: "Documents",
//       description: "Documents & Contacts",
//     },
//   ];
...
//       {/* Right Side - Form Content (80%) */}
//       <div style={{ width: "80%", display: "flex", flexDirection: "column" }}>
//         {/* Step Content */}
//         <div style={{ flex: 1 }}>
//           {currentStep === 0 && (
//             <BasicInformationStep index={index} form={form} />
//           )}
//           {currentStep === 1 && <DocumentsStep index={index} form={form} />}
//         </div>
...
//                   }
//                 >
//                   <CompanyFormWithSteps index={field.name} form={form} />
//                 </Panel>
//               ))}
//             </Collapse>
//           </>
