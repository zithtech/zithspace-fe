...
//   // };
//   const isFieldEditable = (row: TimesheetRow) => {
...
//     });
//   }, [currentDate]);
//   // const entryCount = rows.filter(r => !r.isSummary).length;
//   const entryCount = rows.filter(
//     (row) => row.projectId && row.taskId && (row.hours ?? 0) > 0,
//   ).length;
//   //   const rowsForModal = useMemo(() => {
//   //   // Only count rows that have project, task, and hours > 0
//   //   return rows.filter(row => row.projectId && row.taskId && (row.hours ?? 0) > 0);
//   // }, [rows]);
...
//   //       if (isViewMode) {
//   //         setEmployeeName(sheet.employeeName);
//   //       }
//   //     });
//   //   } else {
//   //     setRows(
...
//         // if (!status) {
//         //   setStatus(sheet.status as "Draft" | "Submitted"); // only set if status empty
//         // }
//         setStatus(sheet.status);
//         setCurrentDate(dayjs(sheet.weekStart));
//       });
...
//   const viewColumns: ColumnsType<TimesheetRow> = [
//     // {
//     //   title: "Date",
...
//     //   title: "Description",
//     //   render: (_: any, r) => (
//     //     <Button type="link" onClick={() => openDesc(r.description??"")}>
//     //       View
//     //     </Button>
//     //   ),
//     // },
...
//           //   onChange={(value) => {
//           //     updateRow(r.key, {
//           //       hours: typeof value === "number" ? value : 0,
//           //     });
//           //   }}
//           // />
//           <InputNumber<number>
...
//     //         <SnippetsOutlined  style={{color:"green"}}onClick={() => handleCopyRow(r)} />
//     //         <UndoOutlined style={{color:"blue"}} onClick={() => handleDeleteRow(r.key)} />
//     //       </Space>
//     //     ),
//     // },
//     !isViewMode && {
...
//         ),
//     },
//   ].filter(Boolean) as ColumnsType<TimesheetRow>;
//   //   {
//   //   title: "ACTIONS",
//   //   width: 150,
//   //   render: (_: any, r: TimesheetRow) =>
...
//   //         {/* Weekend checkbox with tooltip */}
//   //         {isWeekend(r.day) && (
//   //           <Tooltip
//   //             title={
//   //               isFieldEditable(r)
//   //                 ? "You can disable weekend editing"
//   //                 : "Weekend is disabled. Click checkbox to enable editing"
//   //             }
//   //           >
//   //             <Checkbox
//   //               checked={isFieldEditable(r)}
...
//     return TASKS.find((t) => t.value === taskId)?.label || "";
//   };
//   const handleExport = () => {
...
//         //   r.projectId ?? "",
//         //   r.taskId ?? "",
//         getProjectName(r.projectId), // ✅ NAME
...
//           }}
//           // expandable={{
//           //   // ✅ View mode-la expand icon visible
//           //   expandIcon: isViewMode ? undefined : () => null,

//           //   // ✅ Expand automatically when row clicked (optional)
//           //   expandedRowRender: (r) =>
//           //     !r.isSummary &&
//           //     (isViewMode ? (
...
//                       alignItems: "center",
//                       padding: "12px 24px",
//                       //background: "#f5f7fa", // light gray background for distinction
...
//                       <span>{totalBillable} h billable</span>
//                     </span>
//                   </div> */}
//                   <div
//                     style={{
