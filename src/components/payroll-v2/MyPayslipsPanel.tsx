  ...
  return (
    <div className="mps">
      ...
      <style jsx global>{`
        ...
        .mps-header { display: flex; align-items: center; justify-content: space-between; gap: 16px; padding: 14px 22px; margin-bottom: 0; border-bottom: 1px solid var(--border-slate-200); flex-wrap: wrap; background: var(--bg-pure-white); }
        .mps-header-about { display: flex; align-items: center; gap: 12px; flex: 1 1 auto; min-width: 200px; }
        .mps-header-icon { width: 38px; height: 38px; border-radius: 10px; background: ${TINT.cyan}; color: ${PALETTE.cyan}; display: inline-flex; align-items: center; justify-content: center; font-size: 18px; flex-shrink: 0; }
        ...
        .pv-table-wrap { display: flex; flex-direction: column; flex: 1; min-height: 0; background: var(--bg-pure-white); border: 1px solid var(--border-slate-200); border-left: none; border-right: none; overflow: hidden; }
        ...
        .pv-table-wrap .ant-table { flex: 1; display: flex; flex-direction: column; background: transparent; font-size: 12.5px; border-radius: 0px !important; border: none; }
        .pv-table-wrap .ant-table-container { display: flex; flex-direction: column; flex: 1; min-height: 0; overflow: hidden; }
        .pv-table-wrap .ant-table-content { overflow-y: auto !important; overflow-x: auto !important; flex: 1; min-height: 0; }
        .pv-table-wrap .ant-table-thead > tr > th, .pv-table-wrap .ant-table-container table > thead > tr:first-child > th:first-child, .pv-table-wrap .ant-table-container table > thead > tr:first-child > th:last-child { background: var(--bg-slate-50) !important; border-bottom: 1px solid var(--border-slate-200) !important; font-size: 10px !important; font-weight: 700 !important; letter-spacing: 0.04em; text-transform: uppercase; color: var(--text-slate-400) !important; padding: 9px 12px !important; border-radius: 0px !important; border-start-start-radius: 0px !important; border-start-end-radius: 0px !important; }
        .pv-table-wrap .ant-table-tbody > tr > td { border-bottom: 1px solid var(--border-slate-100) !important; padding: 10px 12px !important; }
        .pv-table-wrap .ant-table-tbody > tr:last-child > td { border-bottom: none !important; }
        .pv-table-wrap .ant-table-tbody > tr:hover > td { background: var(--bg-slate-50) !important; }

        .mps-footer { display: flex; align-items: center; justify-content: flex-end; padding: 10px 22px; background: var(--bg-pure-white); border-top: 1px solid var(--border-slate-200); margin-top: auto; }
        .mps-footer--sticky { position: sticky; bottom: 0; z-index: 20; box-shadow: 0 -4px 14px rgba(15, 23, 42, 0.05); }
        ...
        .mps-hero { display: flex; align-items: center; justify-content: space-between; gap: 16px; padding: 20px 24px; margin: 20px 22px 20px 22px; border: 1px solid var(--border-color); border-radius: 12px; background: linear-gradient(120deg, ${TINT.green}, ${TINT.cyan}); }
