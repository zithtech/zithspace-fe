...
export default function ProjectsPage() {
  ...
  const quickActions = [
    ...
    },
    {
      ...
      icon: (
        <UnorderedListOutlined style={{ fontSize: 24, color: "#faad14" }} />
      ),
      ...
      <div style={{ padding: 20 }}>
        ...
        <div style={{ marginBottom: 32 }}>
          ...
          <Paragraph style={{ marginTop: 8, fontSize: 16, color: "#666" }}>
            Comprehensive ticket management system for tracking tasks, managing
            workflows, and coordinating team efforts across multiple projects.
          </Paragraph>
        </div>
