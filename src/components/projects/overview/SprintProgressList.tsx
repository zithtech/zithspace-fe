          ...
          <List.Item style={{ borderBottom: '1px solid #f9f9f9', padding: '12px 0' }}>
            <div className="w-full">
              <Row justify="space-between" align="middle" className="mb-2">
                ...
                <Col>
                  <Text type="secondary" style={{ fontSize: '12px', fontWeight: 500 }}>{item.completedCount}/{item.ticketCount}</Text>
                </Col>
              </Row>
              <Progress
              ...
              <div className="mt-1 flex justify-between">
                ...
                <Tag style={{ fontSize: '10px', borderRadius: '4px', border: 'none', background: item.progress === 100 ? '#f6ffed' : '#f5f5f5', color: item.progress === 100 ? '#52c41a' : '#8c8c8c' }}>
